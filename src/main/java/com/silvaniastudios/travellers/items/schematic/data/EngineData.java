...
public class EngineData implements IProceduralData {
	...
	public static final EngineProp[] EnginePropList = new EngineProp[] { 
			new EngineProp(30, "Z", "j"),
			new EngineProp(0, "X", "j"), 
			new EngineProp(58, "N", "p"),
			new EngineProp(48, "M", "p"),
			new EngineProp(40, "H", "p"), 
			new EngineProp(31, "F", "p"), 
			new EngineProp(25, "B", "p"),
			new EngineProp(20, "U", "p"), 
			new EngineProp(15, "O", "p"),
			new EngineProp(10, "E", "p"),
