...
public class ModItems {
	...
	public static ItemSchematic default_schematic = new ItemSchematic();

	public static ItemSchematic common_engine = new ItemSchematic("engine.common", SchematicTypeEnum.ENGINE,
			SchematicRarityEnum.COMMON);

	public static ItemSchematic uncommon_engine = new ItemSchematic("engine.uncommon", SchematicTypeEnum.ENGINE,
			SchematicRarityEnum.UNCOMMON);

	public static ItemSchematic rare_engine = new ItemSchematic("engine.rare", SchematicTypeEnum.ENGINE,
			SchematicRarityEnum.RARE);

	public static ItemSchematic exotic_engine = new ItemSchematic("engine.exotic", SchematicTypeEnum.ENGINE,
			SchematicRarityEnum.EXOTIC);
	
	public static ItemSchematic pristine_engine = new ItemSchematic("engine.pristine", SchematicTypeEnum.ENGINE,
			SchematicRarityEnum.PRISTINE);
	
	public static ItemSchematic legendary_engine = new ItemSchematic("engine.legendary", SchematicTypeEnum.ENGINE,
			SchematicRarityEnum.LEGENDARY);

	public static ItemSchematic common_wing = new ItemSchematic("wing.common", SchematicTypeEnum.WING,
			SchematicRarityEnum.COMMON);

	public static ItemSchematic uncommon_wing = new ItemSchematic("wing.uncommon", SchematicTypeEnum.WING,
			SchematicRarityEnum.UNCOMMON);

	public static ItemSchematic rare_wing = new ItemSchematic("wing.rare", SchematicTypeEnum.WING,
			SchematicRarityEnum.RARE);

	public static ItemSchematic exotic_wing = new ItemSchematic("wing.exotic", SchematicTypeEnum.WING,
			SchematicRarityEnum.EXOTIC);

	public static ItemSchematic common_cannon = new ItemSchematic("cannon.common", SchematicTypeEnum.CANNON,
			SchematicRarityEnum.COMMON);

	public static ItemSchematic uncommon_cannon = new ItemSchematic("cannon.uncommon", SchematicTypeEnum.CANNON,
			SchematicRarityEnum.UNCOMMON);

	public static ItemSchematic rare_cannon = new ItemSchematic("cannon.rare", SchematicTypeEnum.CANNON,
			SchematicRarityEnum.RARE);

	public static ItemSchematic exotic_cannon = new ItemSchematic("cannon.exotic", SchematicTypeEnum.CANNON,
			SchematicRarityEnum.EXOTIC);

	public static ItemSchematic common_swivel = new ItemSchematic("swivel.common", SchematicTypeEnum.SWIVELCANNON,
			SchematicRarityEnum.COMMON);

	public static ItemSchematic uncommon_swivel = new ItemSchematic("swivel.uncommon", SchematicTypeEnum.SWIVELCANNON,
			SchematicRarityEnum.UNCOMMON);

	public static ItemSchematic rare_swivel = new ItemSchematic("swivel.rare", SchematicTypeEnum.SWIVELCANNON,
			SchematicRarityEnum.RARE);

	public static ItemSchematic exotic_swivel = new ItemSchematic("swivel.exotic", SchematicTypeEnum.SWIVELCANNON,
			SchematicRarityEnum.EXOTIC);
